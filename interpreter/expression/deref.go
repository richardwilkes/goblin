...
func (expr *Deref) Invoke(env *interpreter.Env) (reflect.Value, error) {
	...
	if v.Kind() != reflect.Ptr {
		return interpreter.NilValue, interpreter.NewStringError(expr, "Cannot deference for the value")
	}
	return v.Elem(), nil
}

// Assign a value to the expression and return it.
func (expr *Deref) Assign(rv reflect.Value, env *interpreter.Env) (reflect.Value, error) {
