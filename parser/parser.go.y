...
stmt :
	...
	| expr '=' expr
	{
		$$ = &statement.Variables{Left: []ast.Expr{$1}, Operator: "=", Right: []ast.Expr{$3}}
	}
	| exprMany '=' exprMany
	{
...
expr :
	...
	| TRUE
	{
		$$ = &expression.Const{Value: ast.TrueValue}
		$$.SetPosition($1.Position())
	}
	| FALSE
	{
		$$ = &expression.Const{Value: ast.FalseValue}
		$$.SetPosition($1.Position())
	}
	| NIL
	{
